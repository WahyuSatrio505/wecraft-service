...
<head>
    ...
    <style>
        ...
        .ambient-light {
            ...
            pointer-events: none;
            z-index: -1;
            background: radial-gradient(circle at 80% 10%, rgba(99, 102, 241, 0.08), transparent 30%),
                        radial-gradient(circle at 20% 90%, rgba(14, 165, 233, 0.08), transparent 30%);
        }
...
<body>
    ...
    <!-- Header Section -->
    <section class="pt-5 mt-5 pb-4 text-center">
        <div class="container pt-5">
            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 px-3 py-2 mb-3" data-aos="fade-down">OUR MASTERPIECES</span>
            <h1 class="display-3 fw-bold mb-3 text-white" data-aos="fade-up">Karya yang <span class="text-gradient" style="background: linear-gradient(135deg, #6366f1, #0ea5e9); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Berbicara</span></h1>
            <p class="text-muted lead mx-auto" style="max-width: 600px;" data-aos="fade-up" data-aos-delay="100">
                Kumpulan proyek terbaik yang telah kami kerjakan dengan kombinasi logika kode dan estetika desain.
            </p>

            <!-- Filter Buttons -->
            <div class="d-flex justify-content-center gap-2 flex-wrap mt-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="landing">
                    <div class="project-card h-100" data-aos="fade-up">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-muted small mb-4">Website penjualan kopi dengan fitur tombol WhatsApp Checkout otomatis dan animasi scroll yang halus.</p>
                            <div class="d-flex flex-wrap gap-2">
                                <span class="tech-badge"><i class="bi bi-bootstrap me-1"></i>Bootstrap</span>
                                <span class="tech-badge"><i class="bi bi-filetype-js me-1"></i>JS</span>
                                <span class="tech-badge">AOS</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-card h-100" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="p-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <span class="tech-badge">Ads</span>
                            </div>
                        </div>
                    </div>
                </div>
